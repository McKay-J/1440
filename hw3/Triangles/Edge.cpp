...
double Edge::getLength() const
{
    ...
    if (isValid())
    {
        ...
        double diffY = m_point2->getY() - m_point1->getY(); //TODO $$ It was point to X instead of Y
    ...
    //TODO $$ Added statement if result is less than m_distance
    if(result < 0.001)
    {
        result = 0;
    }
...
}//TODO $$ Changed GetslopeX to GetSlopeZ
